...
Enjoy listening music from youtube without ads distraction. This application works semi offline. When you play a music, it will fetch audio stream from youtube, then save it to local cache. Then it will play from cache the next time you play it again.
